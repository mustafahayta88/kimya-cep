    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        v.findViewById<Button>(R.id.btn_help)?.setOnClickListener {
            AlertDialog.Builder(requireContext())
                .setTitle("Organik Kimya - Molekul Insa")
                .setMessage("Organik kimya, karbon bazli molekulleri inceleyen bilim dalidir.\n\n" +
                    "Bu bolumde kendi molekullerinizi kurabilirsiniz:\n" +
                    "- Element secmek icin alttaki sembollere dokunun\n" +
                    "- Bag olusturmak icin once bir atoma sonra digerine dokunun\n" +
                    "- C halka ve benzen olusturabilirsiniz\n" +
                    "- Orneklerle pratik yapabilirsiniz\n\n" +
                    "Parmak hareketleriyle yakinslastirip uzaklastirabilirsiniz.")
